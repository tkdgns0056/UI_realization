...
<section style="margin: 0 100px 0 100px ;">
  <div class="boardList">
      <div class="board_title">
          <h3 class="title" style="font-family: sans-serif; font-weight: bold;">
              후기게시판
              <span class="title_sub" style="font-family: sans-serif; font-size: 15px;" >
                  상품의 후기를 남겨보세요.
              </span>
          </h3>
      </div>
  ...
  <table class="table" style="margin-top: 30px; font-size: 17px; border-top: 2px solid #333;">
   ...
   <hr/>
   	 <input type="button" class="btn_insert" value="글작성" style="background-color: #378bb3; float: right"   onclick="document.location.href='boardWrite.jsp'">
